...
public class mmfserviceImpl extends Hibernate_Dao  implements mmfservice{
	...
	public List selbydetermine(String obj, String iname, String mine) {
		// TODO Auto-generated method stub
		return getHibernateTemplate().find("from "+obj+" where "+iname+"='"+mine+"'");
	}
	@Override
	public boolean updobj(Object na, String iname, String sn) {
		 ChangeState_Dao(""+na, sn, iname);
		return true;
	}
	@Override
	...
	public boolean updbyid(String voName,String uname,String state,String id) {
		...
		try {
			...
			SQLQuery query = session.createSQLQuery("update " + voName
					+ " set "+uname+"='" + state + "' where id in(" + id + ")");
