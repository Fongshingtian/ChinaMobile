...
<body>
	...
	<script type="text/html" id="imgDemo1">
		<img style='width:100%;height:168px;cursor: pointer;' onclick='maxImg(this.id);' id='img{{d.id}}i1' src='${pageContext.request.contextPath}/imgs/{{d.image1}}'>
	</script>
	<script type="text/html" id="imgDemo2">
		<img style='width:100%;height:168px;cursor: pointer;' onclick='maxImg(this.id);' id='img{{d.id}}i2' src='${pageContext.request.contextPath}/imgs/{{d.image2}}'>
	</script>
	<script type="text/html" id="imgDemo3">
		<img style='width:100%;height:168px;cursor: pointer;' onclick='maxImg(this.id);' id='img{{d.id}}i3' src='${pageContext.request.contextPath}/imgs/{{d.image3}}'>
	</script>
	<script type="text/html" id="imgDemo4">
		<img  style='width:100%;height:168px;cursor: pointer;' onclick='maxImg(this.id);' id='img{{d.id}}i4' src='${pageContext.request.contextPath}/imgs/{{d.image4}}'>
	</script>
	...
	<script>
				...
				table.render({
					...
					cols : [ [ 
						...
						layui.use([ 'jquery', 'layer' ], function() {
							...
							$("#image1").val(imgs.image1);
							$("#image2").val(imgs.image2);
							$("#image3").val(imgs.image3);
							$("#image4").val(imgs.image4);
							//头工具栏事件
							table.on('toolbar(test)', function(obj) {
								if(obj.event=='edit') {
									layui.use([ 'jquery', 'layer' ], function() {
										...
										$("#img1").attr("src","${pageContext.request.contextPath}"+"/imgs/"+imgs.image1);
										$("#img2").attr("src","${pageContext.request.contextPath}"+"/imgs/"+imgs.image2);
										$("#img3").attr("src","${pageContext.request.contextPath}"+"/imgs/"+imgs.image3);
										$("#img4").attr("src","${pageContext.request.contextPath}"+"/imgs/"+imgs.image4);
									})
									//渲染表单
									layui.use(['form', 'layedit', 'laydate'], function(){
									    ...
									    //表单初始赋值
										form.val("formTest", {
										  "image.id": imgs.id // "name": "value"
										 ,"image.image1": imgs.image1 // "name": "value"
										 ,"image.image2": imgs.image2 // "name": "value"
										 ,"image.image3": imgs.image3 // "name": "value"
										 ,"image.image4": imgs.image4 // "name": "value"
										})
									});
								};
							});
		...
		tableData('fss!tableList?voName=RotationImageVo');
		function toReload(){
				tableData('fss!tableList?voName=RotationImageVo');
		}
		//选择图片时-图片预览
		...
		<div class='layui-layer-content'> 
			<center>
				<div style="padding: 150px; line-height: 22px; background-color: white; font-weight: 300;width: 50%;">
					<form  enctype="multipart/form-data" id='ff' lay-filter='formTest' class="layui-form" action="fss!saveVo?voName=Rotation_Image" method='post' >
						<input type="hidden" id='id' name='image.id' value='11'>
						<div class="layui-form-item"> 
							<label class="layui-form-label" >图片一</label>
						</div>
						<div class="layui-form-item">
								<img imgType="list" src='' id='img1' style='width: 500px;height:300px;'>
								<input type="file" onchange="img_show(this,'img1')" name='imgs' id='file1' style='display: none;'> 
								<input type="hidden" name='image.image1' id='image1'>
								<br><br>
						...
						<div class="layui-form-item">
								<img imgType="list" src='' id='img2' style='width: 500px;height:300px;'>
								<input type="file" onchange="img_show(this,'img2')" name='imgs' id='file2' style='display: none;'> 
								<input type="hidden" name='image.image2' id='image2'>
								<br><br>
						...
						<div class="layui-form-item">
								<img imgType="list" src='' id='img3' style='width: 500px;height:300px;'>
								<input type="file" onchange="img_show(this,'img3')" name='imgs' id='file3' style='display: none;'> 
								<input type="hidden" name='image.image3' id='image3'>
								<br><br>
						...
						<div class="layui-form-item">
								<img imgType="list" src='' id='img4' style='width: 500px;height:300px;'>
								<input type="file" onchange="img_show(this,'img4')" name='imgs' id='file4' style='display: none;'> 
								<input type="hidden" name='image.image4' id='image4'>
								<br><br>
								<input type='button' class="layui-btn" onclick="openFile('file4');" value='选择图片'>
						</div>
						<hr style='background: #65bb93'>
						<div class="layui-form-item">
