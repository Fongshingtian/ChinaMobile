...
<body>
	...
	<script>
				...
				table.on('tool(test)', function(obj){
				    ...
				    if(obj.event === 'edit'){
						...
						layui.use(['form', 'layedit', 'laydate'], function(){
						    ...
						    //表单初始赋值
							form.val("formTest", {
							  "manager.id": data.id // "name": "value"
							  ,"manager.nickname": data.nickname // "name": "value"
							  ,"manager.login_name": data.login_name // "name": "value"
							  ,"manager.password":data.password // "name": "value"
		...
		tableData('fss!tableList?voName=ManagerVo');
		//tableData('data.json');
		//添加
		function toAdd(){
			layui.use([ 'jquery', 'layer' ], function() {
		...
		function toSearch(){
			layui.use([ 'jquery', 'layer' ], function() {
				...
				, layer = layui.layer;
				var text=$("#text").val();
				tableData('fss!search?voName=ManagerVo&state='+text);
				$("#text").val(text);
			});
		}
		//刷新数据
		...
		<div class='layui-layer-content'> 
			<center>
				<div style="padding: 150px; line-height: 22px; background-color: white; font-weight: 300;width: 50%;">
					<form  id='ff' lay-filter='formTest' class="layui-form" action="fss!saveVo?voName=Manager" method='post' >
						<input type="hidden" id='id' name='manager.id' value='-1'>
						<div class="layui-form-item">
							<label class="layui-form-label" >人物昵称</label>
							<div class="layui-input-block">
								<input type="text" id='nickname' name="manager.nickname" required lay-verify="required"
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="manager.login_name" required lay-verify="required"
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="password" name="manager.password" required
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="radio" name="manager.state" value="启用" title="启用" checked> <input
									type="radio" name="manager.state" value="禁用" title="禁用" >
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
