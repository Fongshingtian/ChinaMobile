...
<div id="container">
  ...
  <div class="content">
    <div class="where"><strong class="colBlue3">您的位置：</strong> <a href="index.jsp">首页</a> &gt; <a href="chooseNO.jsp">网上选号</a> &gt; 号码选择 &gt; 套餐选择 &gt; 核对订单</div>
    ...
    <table class="bordE0 pro_info_tab">
        ...
        <tr>
            <td class="bordRe0 lh30"><strong class="colBlue">呼和浩特市  号码： 15754925860</strong><br />18元套卡的资费名称：动感地带上网18元卡；<br />
资费描述：套餐费18元，包含本地主叫本地时长30分钟、国内数据流量50M（超出套餐外0.0005元/KB）、来电显示、短信100条。套餐外本地市话主叫0.12元/分钟,国内长途0.25元/分钟，全国被叫免费。0元预开，要求预存金额为50元。</td>
            <td class="tdu fwb f14 colR tac">100元</td>
        </tr>
    </table>
    <!--确定用户资料-->
    <div class="blank10"></div>
    <div class="bordE0 p3 tg_info">
        ...
        <ul class="clearfix col000 pl20 pt10 tg_info_zl">
        	<li class="mb10"><label>客户姓名：<input type="text" class="bdHM bordCc" name=""></label><span class="colR ml20">请预留真实姓名</span></li>
            <li class="mb10"><label>联系电话：<input type="text" class="bdHM bordCc" name=""></label><span class="colR ml20">请预留真实姓名请预留您使用中的手机号码</span></li>
            <li class="mb10"><label>身份证号：<input type="text" class="bdHM bordCc" name=""></label><span class="colR ml20">身份证号码必须与名字匹配</span></li>
    ...
    <div class="bordE0 p3 tg_info f14">
        ...
        <div class="p20 lh24">
            <p>购买手机费用：<strong class="colR">4988￥</strong></p>
            <p class="tar f16 fwb colR mt20">您供需支付：4988￥</p>
        </div>
    </div><!--结算信息end-->
    <div class=" tar pt15">
    	<label><input name="" type="checkbox" value="" class="mr5" />同意</label><a href="javascript:void(0);" class="colBlue ml50">中国移动通信客户入网服务协议</a>
        <p class="mt10"><a href="chooseNO_success.jsp" class="buy_btn r">提交订单</a></p>
    </div>
  </div>
  <div class="blank10"></div>
  <div class="blank10"></div>
