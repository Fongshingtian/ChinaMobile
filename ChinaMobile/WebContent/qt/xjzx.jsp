...
<script type="text/javascript">
	...
	$(function() {
		...
		$.post("mmf!xj.action",{},function(data){
			var srcw='${pageContext.request.contextPath}/imgs/'+data.json.adv;
			 $("#srcs").attr("src",srcw);
			var ms="#aa";
			var pip="#bb";
			var pcp="#cc";
			...
			document.all["xsimg"].innerHTML = '<img src="${pageContext.request.contextPath}/imgs/'+data.json.xsw.photo+'" />';
			...
			document.all["msimg"].innerHTML = '<img src="${pageContext.request.contextPath}/imgs/'+data.json.msw.photo+'" />';
    ...
    <div class="content">
        ...
        <div class="clearfix">
        	<div class="l ovh yyzq_l">
            	<div class="bord1"><a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/images/img/hygj_tu.jpg" width="920" height="205" id="srcs" /></a></div>
...
<script type="text/javascript">
	...
	function spsx(count,l,dqys,ys){
			...
			var aa=$("<a>", {
				href:'mmf!index?id='+u.id+''
			});
			var img=$("<img>", {
				src:'${pageContext.request.contextPath}/imgs/'+u.photo				
			});
			var h3=$("<h3>", {
			});
			var aa1=$("<a>",{
