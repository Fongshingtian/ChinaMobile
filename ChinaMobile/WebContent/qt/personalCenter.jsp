...
<script type="text/javascript">
	...
	//获得评论
	function getcomment(){
		$.post("gj!getUserComment",{id : '${user.id}'},function(data) {
			$("#comment").html("");
			var comment=data.comment;
			var innerHTML = "<tr><td ><div style='margin-left:70px;'>评论内容</div></td><td>宝贝信息</td></tr>";
			for (var i = 0; i < comment.length; i++) {
				innerHTML += "<tr><td colspan='2'><hr style='margin:10px'></td></tr><tr id='address"+i+"' height='40px' valign='top'>"
							+"<td><div style='width:55%;margin-left:70px'>"+comment[i].CONTENT+"<br><br>["+comment[i].DATETIME+"]</div></td>"
							+"<td algin='left' style='width:30%'>"+comment[i].INTRODUCTION+"<br><br>"+comment[i].PRICE+"元</td>";
							+"</tr>";
			} 
				...
				<table cellpadding="10px">
					<tr>
							...
							<ul
								...
								<li style='cursor: pointer;' >
									...
									<div style='display: none'>
										<ul
											style='font-size: 14px; line-height: 30px; font-family: 微软雅黑; width: 200px; margin-left: 30px; text-indent: 10px; letter-spacing: 5px; font-weight: 500;'>
											<li><a href='javescript:void(0);' onclick="getcomment();">我的评论</a></li>
										</ul>
									</div>
								</li>
							</ul>
						...
						<td style='width:80%' valign="top" align="center">
							...
							<!--商品订单end  -->
							<!-- 用户评论 -->
							<div id='comments' dtype='content'
								style='height: 450px;  width: 720px; display: none;'>
								<br> <font style="font-size: 15px; line-height: 10px">评论管理</font>
								<br> <br>
