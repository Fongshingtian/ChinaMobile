	...
	if (m == "baidu") {
		window
				.open('http://cang.baidu.com/do/add?it='
						+ encodeURIComponent(share_title.substring(0, 76))
		...
		window
				.open(
						'http://shuqian.qq.com/post?from=3&title='
								+ encodeURIComponent(share_title) + '&uri='
		...
		void ((function(s, d, e) {
			...
			var f = 'http://v.t.sina.com.cn/share/share.php?', u = d.location.href, p = [
					'url=', e(u), '&title=', e(share_title), '&appkey=330242870' ]
					.join('');
			function a() {
				if (!window
						.open(
...
//			'url' : url,
//			'title' : url == window.location.href ? share_title : null
//		});
...
//						+ (screen.height - 500) / 2);
		...
		try {
			var w = window.open(
					"http://share.51.com/share/share.php?type=8&title="
							+ encodeURIComponent(share_title) + '&vaddr='
		...
		window
				.open(
						"https://skydrive.live.com/sharefavorite.aspx/.SharedFavorites/?marklet=1&mkt=zh-CN&top=1&url="
								...
								+ "&title="
								+ encodeURIComponent(share_title), 'live',
		...
		window.open("http://mail.live.com/secure/start?action=compose&subject="
				+ encodeURIComponent(share_title) + "&body="
		...
		(function() {
			f = 'http://delicious.com/save?url='
					...
					+ encodeURIComponent(share_title) + '&v=5&';
			a = function() {
				if (!window
		...
		(function() {
			window.open(
					'http://www.myspace.cn/Modules/PostTo/Pages/DefaultMblog.aspx?t='
							+ encodeURIComponent(share_title) + '&u='
							+ encodeURIComponent(location.href)
		...
		window.open('http://space.feixin.10086.cn/api/share?source=sharelink&title='+encodeURIComponent(share_title)+'&url='+escape(window.location.href));
	}
